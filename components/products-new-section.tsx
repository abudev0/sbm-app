...
/** % chegirmaga ko'ra final/old narxni hisoblaydi */
...
export function NewProductsSection({ items }: Props) {
  const t = useTranslations("NewProductsSection")
        ...
        <div className="flex items-center gap-0 sm:gap-2">
          ...
          >
            {products.map((p) => {
              ...
              // MUHIM: chegirmali narxni izchil hisoblash
